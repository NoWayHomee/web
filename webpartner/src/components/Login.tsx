  ...
  if (pending) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <div className="w-full max-w-md bg-card border rounded-xl p-8 shadow-sm text-center space-y-4">
          ...
          <div className="pt-2 space-y-2">
            <button
              ...
              className="w-full py-2 rounded-md bg-primary text-primary-foreground font-medium"
            >
              Ve trang dang nhap
            </button>
            <button
              ...
              className="w-full py-2 rounded-md border font-medium hover:bg-accent"
            >
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <form onSubmit={submit} className="w-full max-w-md bg-card border rounded-xl p-8 shadow-sm space-y-4">
        <div className="text-center mb-2">
          <h1 className="text-2xl font-bold text-foreground">Cong doi tac</h1>
        ...
        <div className="flex gap-2 p-1 bg-muted rounded-md">
          <button
            ...
            className={`flex-1 py-1.5 text-sm rounded transition ${mode === "login" ? "bg-card shadow-sm font-medium" : "text-muted-foreground hover:text-foreground"}`}
          >
            Dang nhap
          </button>
          <button
            ...
            className={`flex-1 py-1.5 text-sm rounded transition ${mode === "register" ? "bg-card shadow-sm font-medium" : "text-muted-foreground hover:text-foreground"}`}
          >
            Dang ky
          </button>
        </div>
        ...
        <button disabled={loading} className="w-full py-2.5 rounded-md bg-primary text-primary-foreground font-bold disabled:opacity-50">
          {loading ? "Dang xu ly..." : mode === "login" ? "Dang nhap" : "Dang ky"}
        </button>
        {mode === "register" && (
          <p className="text-xs text-muted-foreground text-center italic">Tai khoan can duoc quan tri vien duyet truoc khi dang nhap.</p>
        )}
      </form>
    </div>
  );
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full px-3 py-2 border rounded-md bg-background focus:ring-1 focus:ring-primary focus:border-primary outline-none transition"
      />
    </div>
  );
}
